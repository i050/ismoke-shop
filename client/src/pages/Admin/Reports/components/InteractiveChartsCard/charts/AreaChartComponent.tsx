/**
 * תרשים אזור - הכנסות לפי קבוצות לקוחות
 * 
 * מציג עמודה עבור כל קבוצת לקוח עם אזור מלא
 * כשגובה האזור משקף את סה"כ ההכנסות מאותה קבוצה
 */
  ...
  return (
    <ResponsiveContainer width="100%" height={320}>
      <BarChart data={dataWithColor} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
        ...
        {/* עמודות הכנסות - צבע דינמי עם כמה שקיפות */}
        <Bar
          dataKey="revenue"
          fill="#10b981"
          name="הכנסות"
